...
using TypeCobol.DocumentModel.File;

namespace TypeCobol.DOM.Test
{
    ...
    public class GrammarTest
    {
        ...
        public void CheckGrammarCorrectnessDOM()
        {
            string regex = "*.PGM";
        ...
        {
            string result = DiagnosticsToString(diagnostics, false);
